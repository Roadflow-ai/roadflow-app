<template>
  <div class="p-8">
    <div class="flex justify-between items-center mb-8">
      <h1 class="text-2xl font-semibold text-gray-900">Engineering</h1>
      <div class="flex space-x-4">
        <button class="bg-green-700 text-white px-4 py-2 rounded-full hover:bg-green-800">
          New Content
        </button>
        <button class="border border-green-700 text-green-700 px-4 py-2 rounded-full hover:bg-green-50">
          Connect Source
        </button>
      </div>
    </div>
    ...
    <div class="space-y-8">
      ...
      <div>
        <h2 class="text-xl font-semibold mb-4">Code Documentation</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <ContentCard
      ...
      <div>
        <h2 class="text-xl font-semibold mb-4">Internal Documentation</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          <ContentCard
